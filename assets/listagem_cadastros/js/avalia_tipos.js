...
function excluir(id){
    if (confirm('Deseja realmente excluir o registro?')) {
        ...
        var nm_avalia_tipo = $('#nm_avalia_tipo').val();
        var url_excluir = $('#url_base').val()+'/excluir/';

        $.post(url_excluir, {
            nm_avalia_tipo: nm_avalia_tipo,
            ci_avalia_tipo: id
...
$(document).ready(function () {
    ...
    $("#btn_consulta").click(function (ev) {
        ...
        // alert('nm_avalia_tipo='+nm_avalia_tipo+' nr_inep='+nr_inep+' cd_turma='+cd_turma+' cd_etapa='+cd_etapa);
