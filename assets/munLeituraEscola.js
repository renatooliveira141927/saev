$(function () {
    $('input[name=rd_rel]').change(function(){
        ...
        if($('input[name=rd_rel]:checked').val()=='M') {
            parametros=$("#cd_etapa").val()+"/"+$("#cd_turma").val()+"/"+$("#cd_disciplina").val()+"/"+$("#cd_avaliacao").val();
            $.ajax({
                ...
                success: function (data){
                    ...
                    //console.log(leitor_fluente);
                        ...
                        xAxis: {
                            categories: meses
                            //categories:['leitor_fluente','leitor_sfluente','leitor_frase','leitor_palavra','leitor_silaba','nao_leitor']
                        },
                        yAxis: {
                            title: {
