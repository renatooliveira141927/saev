        ...
        <?php if ($total_registros > 0) { ?>
            ...
            <div>
                <table class="table table-striped table-hover">
                    <tr>
                        <th></th>
                        <th>Inep escola origem</th>
                        <th>Nome escola origem</th>
                        <th>Inep escola destino</th>
                        ...
                        foreach ($registros as $result) {                            
                            ...
                            <tr>
                                ...
                                <?php } ?>    
                                    ...
                                    <td ><?php echo $result->nr_inep_origem; ?></td>
                                    <td ><?php echo $result->nm_escola_origem; ?></td>
                                    <td ><?php echo $result->nr_inep_destino; ?></td>
                                    ...
                                    <?php } else{ ?>     
                                        <label style="color:#006600">Já Aprovada</label>                                    
                                    <?php } ?>
