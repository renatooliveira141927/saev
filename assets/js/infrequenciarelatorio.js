$(document).ready(function () {
    ...
    $("#btn_consultaescola").click(function (ev) {
        ev.preventDefault();
        $('#carregando').show();
        var cd_escola       = $('#cd_escola').val();
        ...
        var url_listar      = $('#url_base').val()+'/listagem_consultaescola';
        // Carrega as escolas no consulta inicial
        $.post(url_listar, {            
            cd_escola       : cd_escola,
            nr_inep_escola  : nr_inep_escola,
    ...
    $("#btn_consultaturma").click(function (ev) {
        ev.preventDefault();
        $('#carregando').show();
        var cd_escola       = $('#cd_escola').val();
        var nr_inep_escola  = $('#nr_inep_escola').val();
        ...
        var cd_turma        = $('#cd_turma').val();
        var cd_etapa        = $('#cd_etapa').val();        
        var url_listar      = $('#url_base').val()+'/listagem_consultaturma';
        // Carrega as escolas no consulta inicial
        $.post(url_listar, {            
            cd_escola       : cd_escola,
            nr_inep_escola  : nr_inep_escola,
