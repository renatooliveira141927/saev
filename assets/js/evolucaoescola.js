$(function() {
    $('#btSearch').click(function() {
        ...
        if (validaForm()) {
            parametros = $("#cd_disciplina").val() + "/" + $("#cd_etapa").val() + "/" + $("#cd_escola").val()+"/"+$("#nr_anoletivo").val();
            $.ajax({
                //componente:componente.id,
                url: "partials/evolucaoescola/" + parametros,
                type: 'post',
...
function validaForm() {
    ...
    //if(estado==''||cidade==''||etapa==''||disciplina==''){
    if (etapa == '' || disciplina == ''||nr_anoletivo==''){
