...
if (validation_errors()){
    //echo "Comparação=".(trim(validation_errors()) == trim("O campo nome da avalia_tipo é obrigatório."));
    $erro_qtdobrigatorio = "O campo nome da avalia_tipo é obrigatório.";
            ...
            <div class="col-lg-12">
                <table class="table table-striped table-hover">
                    <tr>
                        ...
                        ?>
                            <i onclick="mudaAction('<'?php echo base_url('avalia_tipo/avalia_tipos/gerar_excel'); ?>');" style="cursor: pointer;">
                                <img width="30px" height="30px"  src="<'?php  echo base_url('/assets/images/excel.png');?>"/>
                            </i>
                            <i onclick="mudaAction('<'?php echo base_url('avalia_tipo/avalia_tipos/gerar_pdf'); ?>', '_blank');" style="cursor: pointer;">
                    ...
                    <!-- Inicio lista de avalia_tipos encontradas na consulta -->
                    <?php
                    if($total_registros>0){
                        foreach ($registros as $result) {
                            ...
                            <tr>
                                <td>
                                    <a type="button"
                                    href="<?php echo base_url('avalia_tipo/avalia_tipos/editar/'.$result->ci_avalia_tipo); ?>"
                                ...
                                <td align="right">
                                    ...
                                    <button type="button"
                                            class="btn btn-danger waves-effect waves-light btn-micro active"
                                            onclick="javascript:excluir('<?php echo $result->ci_avalia_tipo;?>');">
                                        Excluir
                                    </button>
