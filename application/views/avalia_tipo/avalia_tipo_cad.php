                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               ...
                               <?php echo 'Cadastro de Tipos de Avaliações'?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        if($msg == "success"){
                                            ...
                                            <script type="text/javascript">
                                                mensagem_sucesso("error" , "Não foi possível realizar o cadastro, pois o tipo de avalição já está cadastrado no banco de dados!");
                                            </script>
                                        ...
                                        ?>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    <label for="nm_avalia_tipo">Nome - Tipo de Avaliação</label>
