...
if (validation_errors()){
    //echo "Comparação=".(trim(validation_errors()) == trim("O campo nome da turno é obrigatório."));
    $erro_qtdobrigatorio = "O campo nome do turno é obrigatório.";
            ...
            <div class="col-lg-12">
                <table class="table table-striped table-hover">
                    <tr>
                        ...
                        ?>
                            <i onclick="mudaAction('<'?php echo base_url('turno/turnos/gerar_excel'); ?>');" style="cursor: pointer;">
                                <img width="30px" height="30px"  src="<'?php  echo base_url('/assets/images/excel.png');?>"/>
                            </i>
                            <i onclick="mudaAction('<'?php echo base_url('turno/turnos/gerar_pdf'); ?>', '_blank');" style="cursor: pointer;">
                    ...
                    <!-- Inicio lista de turnos encontradas na consulta -->
                    <?php
                    if($total_registros>0){
                        foreach ($registros as $result) {
                            ...
                            <tr>
                                <td>
                                    <a type="button"
                                    href="<?php echo base_url('turno/turnos/editar/'.$result->ci_turno); ?>"
                                ...
                                <td align="right">
                                    ...
                                    <button type="button"
                                            class="btn btn-danger waves-effect waves-light btn-micro active"
                                            onclick="javascript:excluir('<?php echo $result->ci_turno;?>');">
                                        Excluir
                                    </button>
