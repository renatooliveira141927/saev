                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <div class="col-lg-12">
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="cd_edicao" name="cd_edicao" class="form-control">
                                                                <Option value=""></Option>
                                                                <?php
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="cd_etapa" name="cd_etapa" class="form-control">
                                                                <Option value=""></Option>
                                                                <?php
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="cd_turma" name="cd_turma" class="form-control">
                                                                <Option value=""></Option>
                                                                <?php
                                                ...
                                                <input type="hidden" id="id" name="id" value="<?php echo $result->ci_aluno?>">
