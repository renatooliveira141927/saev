	...
	<div class="container">
        <div class="page-title-box">
            <div class="col-md-10" style="text-align: left">
                <p>
                    <h4 class="page-title"><?php echo 'Consultar Infrequ&ecirc;ncia ' ?></h4>
                </p>
            </div>
            <div class="col-md-2" style="text-align: right">
                <p>
                    <a type="button" class="btn btn-custom waves-effect waves-light btn-micro active    "
                       href="<?php echo base_url('infrequencia/infrequencia/novo'); ?>">Cadastrar</a>
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <?php }elseif ($this->session->userdata('ci_grupousuario') == 2){?> <!-- Se o usuário for SME-->
                    ...
                    <div class="col-lg-10">
                        <div class="form-group">
                            <label for="cd_escola">Escola *</label>
                            <select id="cd_escola" name="cd_escola" tabindex="5" class="form-control"
                                onchange="escola_selecionda(this.value);">
                                <Option value="" nr_inep=""></Option>
                                <?php
                ...
                <div  class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select id="cd_turma" name="cd_turma" tabindex="6" 
                ...
                <div  class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select id="cd_etapa" name="cd_etapa" tabindex="7" class="form-control" onchange="zerar_turma('cd_turma');">
                            <Option value=""></Option>
                            <?php
