                ...
                <table class="table table-striped table-hover">
                    ...
                    if($total_registros>0){
                        foreach ($registros as $result) {
                            ?>
                            <tr>                        
                            	<?php if($result->fl_ativo=='t'){?>        
                                	<td style="color:#3fb061;"><?php echo $result->nm_cidade; ?></td>
                                	<td style="color:#3fb061;"><?php echo $result->mes; ?></td>                                
                                	<td style="color:#3fb061;">Ativo</td>
                                <?php }ELSE{ ?>	      
                                	<td style="color:#ff0000;"><?php echo $result->nm_cidade; ?></td>
                                	<td style="color:#ff0000;"><?php echo $result->mes; ?></td>                                
                                	<td style="color:#ff0000;">Desativado</td>
                                <?php }?>	                          
                            </tr>
                        <?php }  
                    } ?>
