<script src="<?=base_url('assets/js/transacoes.js'); ?>"></script>
            ...
            <div class="col-md-2" style="text-align: right">
                <p>
                    <a type="button" class="btn btn-custom waves-effect waves-light btn-micro active    "
                       href="<?php echo base_url('usuario/transacoes/novo'); ?>">Cadastrar</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card-box">
                <div >
                        ...
                        <div class="col-lg-12">
                            <section class="main row">
                                <div class="form-group">
                                    <label for="nm_transacao">Nome do transação</label>
                                    <input type="text"
                                           name="nm_transacao"
                                           id="nm_transacao"
                                           tabindex="2"
                                           placeholder="Nome do transação"
                                           style="text-transform: uppercase;"
                                           class="form-control"
                                           value="<?php echo set_value('nm_transacao');?>">
                    ...
                    <input type="hidden"
                           id="url_base"
                           value="<?php echo base_url('usuario/transacoes/')?>">
