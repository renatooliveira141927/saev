...
if($msg == "success"){
    ...
    echo form_open('professor/professores/salvar',array('ci_professor'=>'frm_professores','method'=>'post', 'enctype'=>'multipart/form-data'));
...
<div class="container">
    <div  class="card-group">
        <div id="page-wrapper" >
                <div class="row">
                    <div class="col-lg-12">
                                <h3 class="page-header">Editar cadastro de professor </h3>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    <input  type="hidden" 
                                        ...
                                        <a href="#" onclick="$('#img').click();">
                                            <img  type="button"  id="img_preview" 
                                                    src="
                                                        <?php if ($result->img) {
                                                            echo base_url('/assets/img/professores/'.$result->img);
                                                        }else{ 
                                            ...
                                            <div class="form-control ">
                                                <label class="radio-inline control-label" for="formacao_p">
                                                    <input  type="radio" 
                                                        ...
                                                        <?php if($result->fl_formacao == 'P'){ echo 'checked'; } ?>>
                                                    Pedagogia
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <label class="radio-inline control-label" for="formacao_lo">
                                                    <input  type="radio" 
                                                        ...
                                                        <?php if($result->fl_formacao == 'LO'){ echo 'checked'; } ?>>
                                                ...
                                                <label class="radio-inline control-label" for="formacao_m">
                                                    <input  type="radio" 
                                                            ...
                                                            tabindex="12" 
                                                            onclick="controlar_divs('');"
                                                        <?php if($result->fl_formacao == 'M'){ echo 'checked'; } ?>>
                                                ...
                                                <label class="radio-inline control-label" for="formacao_o" >
                                                    <input  type="radio" 
                                                        ...
                                                        <?php if($result->fl_formacao == 'O'){ echo 'checked'; } ?>>
                                                    Outros
                                                </label>
                                        </fieldset>
                                        <script>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group col-lg-12" id="dv_outra_formacao" 
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control"
                                            value="<?php echo $result->ds_outra_formacao?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group col-lg-12" id="dv_nm_formacao_letras" 
                                        <?php if($result->fl_formacao != 'LO'){ ?>
                                            style="display:none;"
                                        <?php } ?>>
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control"
                                            value="<?php echo $result->nm_formacao_letras?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div  align="right">
                                        <input type="hidden" id="ci_professor" name="ci_professor" value="<?php echo $result->ci_professor?>">
                                        <button type="submit" 
