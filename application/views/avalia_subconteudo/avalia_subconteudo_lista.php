...
<!--            </button>-->
            ...
            <button type="button" onclick="mudaAction('<?php echo base_url('avalia_subconteudo/avalia_subconteudos/gerar_excel'); ?>');">
                <img width="30px" height="30px"  src="<?php  echo base_url('/assets/images/excel.png');?>"/>
            </button>
            <button type="button" onclick="mudaAction('<?php echo base_url('avalia_subconteudo/avalia_subconteudos/gerar_pdf'); ?>');">
        ...
        <div class="col-lg-12">
            <table class="table table-striped table-hover">
                ...
                <!-- Inicio lista de avalia_subconteudos encontradas na consulta -->
                <?php
                foreach ($registros as $result) {
                    ...
                    <tr>
                        <td>
                            <a type="button"
                               href="<?php echo base_url('avalia_subconteudo/avalia_subconteudos/editar/'.$result->ci_avalia_subconteudo); ?>"
                               style="width: 80px;height: 33px"
                               class="btn btn-custom waves-effect waves-light btn-micro active">Editar</a>

                        </td>
                        <td ><?php echo $result->ci_avalia_subconteudo; ?></td>
                        <td><?php echo $result->nm_avalia_subconteudo; ?></td>
                        <td align="right">
                            <input type="hidden" id="url_excluir"
                                   value="<?php echo base_url('avalia_subconteudo/avalia_subconteudos/excluir/')?>">

                            <button type="button"
                                    class="btn btn-danger waves-effect waves-light btn-micro active"
                                    onclick="javascript:excluir('<?php echo $result->ci_avalia_subconteudo;?>');">
                                Excluir
                            </button>
