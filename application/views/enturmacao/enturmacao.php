...
<script src="<?=base_url('assets/js/enturmacoes.js'); ?>"></script>
...
<script>
    ...
    function escola_selecionada(id_escola,cd_turma,anoletivo ){
        add_inep_escola();
        if(id_escola==''){
            alert('Para liberar o campo de Turmas é necessário selecionar a Escola e o Ano Letivo');
        }else{
            populaturmaanoletivo('',id_escola,cd_turma, anoletivo);
        }        
    }
    ...
    <div class="container">
        <div class="page-title-box">
            <div class="col-md-10" style="text-align: left">
                <p>
                    <h4 class="page-title"><?php echo 'ENTURMAÇÃO DE ALUNOS' ?></h4>
                </p>
            </div>
    ...
    <?php
        ...
        echo form_open('enturmacao/enturmacoes/salvar',array('id'=>'frm_enturmacao','method'=>'post', 'enctype'=>'multipart/form-data'));
    ?>
        ...
        <div class="container card-box">
            <div class="col-md-12">
                ...
                <div  class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select id="nr_anoletivo" 
                                    ...
                                    tabindex="3"
                                    class="form-control"                                    
                                    onchange="escola_selecionada($('#cd_escola').val(),'',this.value);">
                                <?php echo $anos ?>
                            </select>
                    </div>
                </div>        
                ...
                <div  class="col-lg-2">
                    <div class="form-group">
                        <label for="nr_inep_aluno">Inep do aluno</label>
                        <input type="text"
                            name="nr_inep_aluno"
                            id="nr_inep_aluno"
                            tabindex="9"
                            placeholder="Inep"
                            class="form-control"
                            value="<?php echo set_value('nr_inep_aluno'); ?>">
                    </div>
                </div>
                <div  class="col-lg-10">
                    <div class="form-group">
                ...
                <div align="right">        
                    <input type="hidden"
                            id="url_base"
                            value="<?php echo base_url('enturmacao/enturmacoes')?>">
                        <a id="btn_consulta"></a>
                    <a type="button" id="btn_consulta_enturmacao"
                            tabindex="11"                            
                    ...
                    <script type="text/javascript">
                        function validaform(){
                            ...
                            if ($('#nr_anoletivo').val()==0 ||$('#nr_anoletivo').val()==''){
                                validacao = true;
                            }
                            if (validacao){
    ...
    if($msg == "success"){ ?>
        ...
        <script type='text/javascript'>        
            var cd_escola = '<?php echo set_value('cd_escola')?>';
            var cd_turma = '<?php echo set_value('cd_turma')?>';

            $(document).ready(function() {
                
                if (cd_escola){
                    pesquisa_cd_escola(cd_escola);
                    escola_selecionada(cd_escola, cd_turma);
                }
