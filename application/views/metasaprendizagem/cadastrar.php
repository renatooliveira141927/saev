    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="col-md-10" style="text-align: left">
                <p>
                    <h4 class="page-title"><?php echo 'Adicionar: Metas de Aprendizagem'?></h4>
                </p>
            </div>            
        </div>
    </div>
...
if($msg == "success"){
    ...
    <div class="container card-box">
        <form action="<?php echo base_url('metasaprendizagem/metasaprendizagem/gravar'); ?>" method="post" id="gravar" name="gravar">            
