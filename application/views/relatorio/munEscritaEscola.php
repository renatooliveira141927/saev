...
<div class="container">
    <div class="page-title-box">
        <div class="col-md-10" style="text-align: left">
            <p>
            <h4 class="page-title"><?php echo 'Município:Escrita por Escola' ?></h4>
            </p>
        </div>
    </div>
            ...
            <div class="col-lg-12">
            	<table class="table table-striped table-hover">            		
                    ...
                    <?php $pttacertos=0;$qtdacertos=0;
                            $qttotal=0;
                        if( isset($avaliacao) && isset($totalDesc) && !empty($totalDesc)){
                ...
                <table class="table table-striped table-hover">
                    <tr>                    	
                        ...
                        <?php if( isset($registrosDesc) ){
                                ...
                                if($escolaAtual!="" && $escolaAtual!=$item->nm_escola){
                                    ...
                                    <td align="center" valign="middle"
                                        <?php if($pacertos<=25){?>
                                            style="color: white; background:#E60000"
                                        <?php }?> 
                                        <?php if($pacertos>25 && $pacertos<=50){?>                                        
                                            style="color: white; background:#FF9900"
                                        <?php }?> 
                                        <?php if($pacertos>50 && $pacertos<=75){?>                                        
                                            style="color: white; background:#81c93a"
                                        <?php }?>
                                        <?php if($pacertos>75){?>
                                            style="color: white; background:#006600"
                            ...
                            echo '</tr>';
                            echo '<strong>Total de Escolas:</strong>'.$nr_escolas;
                        }?>                    
                </table>
            </div>
        </div>
