...
<div class="container">
    <div class="page-title-box">
        <div class="col-md-10" style="text-align: left">
            <p>
            <h4 class="page-title"><?php echo 'Lançamento Avaliacao: Geral' ?></h4>
            </p>
        </div>
    </div>
        	...
        	<?php if(!empty($lancamento)){ 
        	    foreach ($lancamento as $result) {?>
                 <tr>                 	
                 	...
                 	<td ><a href="<?php echo base_url('lancamento/lancamentoMunicipio?estado='.$result->ci_estado.'&cidade='.$result->ci_cidade.'&edicao='.$result->cd_edicao) ?>"
                 			target="_blank">
