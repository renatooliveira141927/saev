...
<div class="container">
    <div class="page-title-box">
        <div class="col-md-10" style="text-align: left">
            <p>
            <h4 class="page-title"><?php echo 'Percentual de Acerto por Habilidade Avaliada' ?></h4>
            </p>
        </div>
    </div>
    <div class="container card-box">
        <form action="" method="post" id="habilidadeavaliada" name="habilidadeavaliada">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <select id="cd_avaliacao" name="cd_avaliacao" tabindex="10" class="form-control"
                            onchange="populatopicos();buscaencerramentomunicipio();" >
...
<script src="<?=base_url('assets/js/habilidadeAvaliada.js'); ?>"></script>
<script>
    function printPage(){
        var $panels = $('.panel');
