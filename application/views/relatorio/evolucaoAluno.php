...
<div class="container">
    <div class="page-title-box">
        <div class="col-md-10" style="text-align: left">
            <p>
            <h4 class="page-title"><?php echo 'Linha Evolutiva: Aluno' ?></h4>
            </p>
        </div>
    </div>
    ...
    <div class="container card-box">
        <form action="" method="post" id="evolucaoaluno" name="evolucaoaluno">
...
<script src="<?=base_url('assets/js/evolucaoaluno.js'); ?>"></script>
<script>
    function printPage(){
        var $panels = $('.panel');
