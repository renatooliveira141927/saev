...
<div class="container">
    <div class="page-title-box">
        <div class="col-md-10" style="text-align: left">
            <p>
            <h4 class="page-title"><?php echo 'Monitoramento: Enturmacao por Escola' ?></h4>
            </p>
        </div>
    </div>
        ...
        <div class="table-responsive" id="listagem_resultado">
        	...
        	<?php if(!empty($enturmacaomunicipio)){ 
        	   foreach ($enturmacaomunicipio as $result) {?>
                 <tr>                 	
                 	<td><a href="<?php echo base_url('monitoramento/enturmacao_turma?estado='.$result->cd_estado.'&cidade='.$result->cd_cidade.'&escola='.$result->ci_escola.'&turma='.$result->ci_turma.'&nr_anoletivo='.$anoatual) ?>"
                 			target="_blank">
