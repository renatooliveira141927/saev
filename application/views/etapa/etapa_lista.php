...
if (validation_errors()){
    //echo "Comparação=".(trim(validation_errors()) == trim("O campo nome da etapa é obrigatório."));
    $erro_qtdobrigatorio = "O campo nome da etapa é obrigatório.";
            ...
            <div class="col-lg-12">
                <table class="table table-striped table-hover">
                    <tr>
                        ...
                        ?>
                            <i onclick="mudaAction('<'?php echo base_url('etapa/etapas/gerar_excel'); ?>');" style="cursor: pointer;">
                                <img width="30px" height="30px"  src="<'?php  echo base_url('/assets/images/excel.png');?>"/>
                            </i>
                            <i onclick="mudaAction('<'?php echo base_url('etapa/etapas/gerar_pdf'); ?>', '_blank');" style="cursor: pointer;">
                    ...
                    <!-- Inicio lista de etapas encontradas na consulta -->
                    <?php
                    if($total_registros>0){
                        foreach ($registros as $result) {
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <button type="button"
                                            class="btn btn-danger waves-effect waves-light btn-micro active"
                                            onclick="javascript:excluir('<?php echo $result->ci_etapa;?>');">
                                        Excluir
                                    </button>
