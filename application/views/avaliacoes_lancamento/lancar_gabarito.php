...
<script>
    ...
    <div class="container">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select id="cd_etapa" name="cd_etapa" tabindex="7" class="form-control" disabled
                                    onchange="populaturmaescolaofertaano(this.value)">
                                <Option value=""></Option>
                                <?php
        ...
        <?php echo date('Y-d-m')<=date('2021-30-01')?'teste':'naoteste';?>
    <!-- Inicio Div Gabarito -->
                                ...
                                <div  class='col-md-12'>
                                    <div class='col-md-12 form-group'style="background-color:#c9cccf" >
                                        <div class='col-md-8'>
                                            ...
                                            <input type='hidden' id='cd_avaliacao' name='cd_avaliacao' class="cd_avaliacao" value='<?=$result->ci_avaliacao?>'/>
                                        ...
                                        <div class='col-md-4'>
                                            <select id='cd_participou' name='cd_participou' tabindex='10'
                                                ...
                                                <option value='6' <?php if($result->cd_situacao_aluno==6){echo 'selected';}else{echo '';} ?> >6 - NAO PARTICIPOU - OUTRAS SITUAÇÕES</option>
                                                <option value='7' <?php if($result->cd_situacao_aluno==7){echo 'selected';}else{echo '';} ?> >7 - NAO PARTICIPOU POR MOTIVO DE DEFICIÊNCIA</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-12'>
                                			<?php if($result->cd_situacao_aluno!=1){?>
                                        		<div id='divGabarito_aluno_<?=$result->ci_aluno?>'style="display: none;">                                        
                                                <?php foreach ($itens as $resul) {
                                                    if($resul->fl_ativo=='t'){?>
                                                    <div class='col-md-2' >
                                               ...
                                               <?php if($result->cd_situacao_aluno==1){?>
                                                <div id='divGabarito_aluno_<?=$result->ci_aluno?>' >
                                                    <?php $itematual=0;
                                                    foreach ($itensinseridos as $item) {                                                        
                                                        if($item->cd_aluno==$result->ci_aluno
                                                            && $itematual!=$item->nr_questao){?>
                                                            <!-- #mudança -->
                                                            <div class='col-md-2' >
                                                                <label><?=$item->nr_questao?></label>                                                                
                                                                <input type='hidden' name='itens[]' value='<?=$item->ci_avaliacao_matriz?>'>
                                                                <select id='cd_item' name='cd_item[]' class='form-control' >
                                                                    <option value=''>Selecione</option>
                                                                    <option value='1' <?php if($item->nr_alternativa_escolhida==1){echo 'selected';}else{echo '';} ?> >A</option>
                                                                    <option value='2'<?php if($item->nr_alternativa_escolhida==2){echo 'selected';}else{echo '';} ?> >B</option>
                                                                    <option value='3' <?php if($item->nr_alternativa_escolhida==3){echo 'selected';}else{echo '';} ?>>C</option>
                                                                    <option value='4'<?php if($item->nr_alternativa_escolhida==4){echo 'selected';}else{echo '';} ?> >D</option>
                                                                </select>
                                                            </div>
                                                       <?php $itematual=$item->nr_questao;} }?>
                                                	</div>
                                                <?php }?>                                       
                                </div>
                                <div class='col-md-12'>
