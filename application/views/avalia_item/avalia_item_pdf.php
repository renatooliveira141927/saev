...
<body>
    ...
    <div>
        <div >
			<h3><center><i class="fa fa-eye"></i> Item de avaliação de nº. <?php echo $result->ci_avalia_item; ?></center></h3>
...
-->
				    ...
				    <div>
	                    ...
	                    <div align="center">
			                <img class="img-responsive img-thumbnail" width="150" height="150" src="<?php echo $_SERVER['DOCUMENT_ROOT'].'/codeigniter/assets/img/avalia_itens/'.$result->ds_img_suporte ?>">   
			            </div>
		            </div>
