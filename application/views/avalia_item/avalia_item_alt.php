...
if($msg == "success"){
    ...
    echo form_open('avalia_item/avalia_itens/salvar',array('ci_avalia_item'=>'frm_avalia_itens','method'=>'post', 'enctype'=>'multipart/form-data'));
...
<div class="container">
    <div  class="card-group">
        <div id="page-wrapper" >
                <div class="row">
                    <div class="col-lg-12">
                                <h3 class="page-header">Alterar item - <?php echo $result->ci_avalia_item; ?></h3>
                            ...
                            <div >
                                <div class="form-group">
                                    ...
                                    <input id="ds_codigo"
                                                    ...
                                                    value="<?php echo $result->ds_codigo;?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="cd_dificuldade" name="cd_dificuldade" tabindex="2" class="form-control">
                                            ...
                                            foreach ($avalia_dificuldades as $item) {
                                                ...
                                                <Option value="<?php echo $item->ci_avalia_dificuldade; ?>"
                                                    <?php if ($result->cd_dificuldade == $item->ci_avalia_dificuldade){
                                                        echo 'selected';
                                                    } ?> >
                                    ...
                                    <select id="cd_avalia_conteudo" name="cd_avalia_conteudo" tabindex="5" class="form-control">
                                        ...
                                        foreach ($avalia_conteudos as $item) {
                                            ...
                                            <Option value="<?php echo $item->ci_avalia_conteudo; ?>"
                                                <?php if ($result->cd_avalia_conteudo == $item->ci_avalia_conteudo){
                                                    echo 'selected';
                                                } ?> >
                                    ...
                                    <select id="cd_avalia_subconteudo" name="cd_avalia_subconteudo" tabindex="6" class="form-control">
                                        ...
                                        foreach ($avalia_subconteudos as $item) {
                                            ...
                                            <Option value="<?php echo $item->ci_avalia_subconteudo; ?>"
                                                <?php if ($result->cd_avalia_subconteudo == $item->ci_avalia_subconteudo){
                                                    echo 'selected';
                                                } ?> >
                                    ...
                                    <select id="cd_avalia_origem" name="cd_avalia_origem" tabindex="7" class="form-control">
                                        ...
                                        foreach ($avalia_origens as $item) {
                                            ...
                                            <Option value="<?php echo $item->ci_avalia_origem; ?>"
                                                <?php if ($result->cd_avalia_origem == $item->ci_avalia_origem){
                                                    echo 'selected';
                                                } ?> >
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="ds_titulo"
                                                    ...
                                                    value="<?php echo $result->ds_titulo; ?>">                                                     
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea   id="ds_texto_suporte"
                                            ...
                                            <?php echo $result->ds_texto_suporte; ?>
                                        </textarea>   
                                        <input  type="text" 
                                                        class="form-control" 
                                                        name="ds_fonte_texto" 
                                                        ...
                                                        tabindex="12"
                                                        value="<?php echo $result->ds_fonte_texto; ?>">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group " id="campo_imagem" name="ds_img_suporte">
                                                ...
                                                <input  type="file" 
                                                        ...
                                                        value="<?php echo $result->ds_img_suporte ?>"/>
                                                <input  type="hidden"
                                                        name="ds_img_suporte_hidden"
                                                        value="<?php echo $result->ds_img_suporte ?>">         
                                                <input  type="text" 
                                                        class="form-control" 
                                                        ...
                                                        tabindex="12"
                                                        value="<?php echo $result->ds_fonte_imagem; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <img    id="img_suporte_preview" 
                                                    ...
                                                    width="200" 
                                                    height="200" 
                                                    src="<?php echo base_url('/assets/img/avalia_itens/'.$result->ds_img_suporte);?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group"> <!-- DIV Alternativa 01 -->
                                        ...
                                        <label for="ds_primeiro_item">Alternativa 01 (Marque a opção correta)  </label>
                                         <div class="input-group itens_questoes">
                                            ...
                                            <div>                                                
                                                <div id="div_ds_primeiro_item_img" 
                                                    <?php if($result->fl_tipo_itens == 'T'){ ?>
                                                        style="display:none;"
                                                    <?php }?>>
                                                    <div class="col-md-9">
                                                        <div class="form-group " id="campo_imagem">
                                                            <input  type="file" 
                                                                    ...
                                                                    value="<?php echo base_url('/assets/img/avalia_itens/'.$result->ds_img_item_01); ?>"/>                                                                    
                                                        <input  type="hidden" name="ds_img_item_01_hidden" value="<?php echo $result->ds_img_item_01 ?>">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img    id="ds_img_item_01_preview" 
                                                                    ...
                                                                    width="200" 
                                                                    height="200" 
                                                                    <?php if (!$result->ds_img_item_01){ ?>
                                                                        style="display:none"
                                                                    <?php } ?>
                                                                    src="
                                                            <?php echo base_url('assets/img/avalia_itens/'.$result->ds_img_item_01); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="div_ds_primeiro_item_texto"
                                                    <?php if($result->fl_tipo_itens == 'I'){ ?>
                                                        style="display:none;"
                                                    <?php }?>>
                                        ...
                                        <input id="ds_justificativa_01"
                                                    ...
                                                    value="<?php echo $result->ds_justificativa_01; ?>">                                                     
                                    </div>
                                    <div class="form-group">  <!-- DIV Alternativa 02 -->
                                        <label for="ds_segundo_item">Alternativa 02 (Marque a opção correta)  </label>
                                        <div class="input-group itens_questoes">
                                            <span class="input-group-addon">
                                                <input  type="radio" 
                                                        name="nr_alternativa_correta" 
                                            ...
                                            <div>                                                
                                                <div id="div_ds_segundo_item_img" 
                                                    <?php if($result->fl_tipo_itens == 'T'){ ?>
                                                        style="display:none;"
                                                    <?php }?>>
                                                    <div class="col-md-9">
                                                        <div class="form-group " id="campo_imagem">
                                                            <input  type="file" 
                                                                    ...
                                                                    value="<?php echo base_url('/assets/img/avalia_itens/'.$result->ds_img_item_02); ?>"/>   
                                                            <input  type="hidden" name="ds_img_item_02_hidden" value="<?php echo $result->ds_img_item_02 ?>">                                                                 
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img    id="ds_img_item_02_preview" 
                                                                    ...
                                                                    width="200" 
                                                                    height="200" 
                                                                    <?php if (!$result->ds_img_item_02){ ?>
                                                                        style="display:none"
                                                                    <?php } ?>
                                                                    src="
                                                            <?php echo base_url('assets/img/avalia_itens/'.$result->ds_img_item_02); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <input id="ds_justificativa_02"
                                                    ...
                                                    tabindex="23"
                                                    placeholder="Digite uma justificativa"
                                                    value="<?php echo $result->ds_justificativa_02; ?>">                                                      
                                    </div>
                                    
                                    <div class="form-group"> <!-- DIV Alternativa 03 -->

                                        <label for="ds_terceiro_item">Alternativa 03 (Marque a opção correta)  </label>
                                        <div class="input-group itens_questoes">
                                            <span class="input-group-addon">
                                                <input  type="radio" 
                                                        name="nr_alternativa_correta" 
                                            ...
                                            <div>                                                
                                                <div id="div_ds_terceiro_item_img" 
                                                    <?php if($result->fl_tipo_itens == 'T'){ ?>
                                                        style="display:none;"
                                                    <?php }?>>
                                                    <div class="col-md-9">
                                                        <div class="form-group " id="campo_imagem">
                                                            <input  type="file" 
                                                                    ...
                                                                    value="<?php echo base_url('/assets/img/avalia_itens/'.$result->ds_img_item_03); ?>"/>      
                                                            <input  type="hidden" name="ds_img_item_03_hidden" value="<?php echo $result->ds_img_item_03 ?>">                                                               
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img    id="ds_img_item_03_preview" 
                                                                    ...
                                                                    width="200" 
                                                                    height="200" 
                                                                    <?php if (!$result->ds_img_item_03){ ?>
                                                                        style="display:none"
                                                                    <?php } ?>
                                                                    src="
                                                            <?php echo base_url('assets/img/avalia_itens/'.$result->ds_img_item_03); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <input id="ds_justificativa_03"
                                                    ...
                                                    tabindex="27"
                                                    placeholder="Digite uma justificativa"
                                                    value="<?php echo $result->ds_justificativa_03; ?>">                                                  
                                    </div>

                                    <div class="form-group"> <!-- DIV Alternativa 03 -->
                                    
                                    <label for="ds_quarto_item">Alternativa 04 (Marque a opção correta)  </label>
                                        <div class="input-group itens_questoes">
                                            <span class="input-group-addon">    
                                                <input  type="radio" 
                                                        name="nr_alternativa_correta" 
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group " id="campo_imagem">
                                                            <input  type="file" 
                                                                    ...
                                                                    value="<?php echo base_url('/assets/img/avalia_itens/'.$result->ds_img_item_04); ?>"/>    
                                                            <input  type="hidden" name="ds_img_item_04_hidden" value="<?php echo $result->ds_img_item_04 ?>">                                                                
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img    id="ds_img_item_04_preview" 
                                                                    ...
                                                                    width="200" 
                                                                    height="200" 
                                                                    <?php if (!$result->ds_img_item_04){ ?>
                                                                        style="display:none"
                                                                    <?php } ?>
                                                                    src="
                                                            <?php echo base_url('assets/img/avalia_itens/'.$result->ds_img_item_04); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <input id="ds_justificativa_04"
                                                    ...
                                                    tabindex="31"
                                                    placeholder="Digite uma justificativa"
                                                    value="<?php echo $result->ds_justificativa_04; ?>">                                                        
                                    </div>
                                    <input type="hidden" id="ci_avalia_item" name="ci_avalia_item" value="<?php echo $result->ci_avalia_item?>">        
                                    <div  align="right">
                                        <button type="submit" 
