                        ...
                        foreach ($registros as $result) {
                            ...
                            <tr>
                                <td>
                                    ...
                                    <td ><?php echo strtoupper ($result->nm_aluno); ?></td>
                                    <td ><?php echo strtoupper ($result->nm_mae); ?></td>
                                    <td ><?php echo $result->dt_nascimento; ?></td>
                                    <td><?php echo strtoupper ($result->nm_etapa); ?></td>
                                    <td><?php echo strtoupper ($result->nm_turma); ?></td>
                                    <td><?php echo strtoupper ($result->nm_turno); ?></td>
                                    <td align="right">
