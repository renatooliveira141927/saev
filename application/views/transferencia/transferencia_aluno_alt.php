...
<div class="container">
    <div  class="card-group">
        <div id="page-wrapper" >
                <div class="row">
                    <div class="col-lg-12">
                                <h3 class="page-header">Aprovação de Transferência</h3>
                    ...
                    <div class="col-lg-12 form-group" id="dv_gruposme"> 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                             <fieldset>
                                 <legend>Escola de Origem</legend>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <label for="nr_inep_escola">Inep: </label>&nbsp;&nbsp;<?php echo $resultado->nr_inep_origem?> &nbsp;&nbsp;&nbsp;  
                                    <label for="nr_inep_escola">Escola: </label>&nbsp;&nbsp;<?php echo strtoupper ($resultado->nm_escola_origem)?><br/>

                                    <label for="nr_inep_escola">Nome: </label>&nbsp;&nbsp;<?php echo strtoupper ($resultado->nm_aluno)?> &nbsp;&nbsp;&nbsp; <br/>
                                    <label for="nr_inep_escola">Mãe: </label>&nbsp;&nbsp;<?php echo strtoupper ($resultado->nm_mae)?> &nbsp;&nbsp;&nbsp;<br/>
                            ...
                            <fieldset>
                                 <legend>Escola de Destino</legend>    
...
function validaForm(){
	...
	var turno=$('#cd_turno').val();
	if(turma==''||etapa==''||turno==''){
		alert('Verifique o preenchimento dos campos com asterísco (*)!');
		return false;
	}else{
		$('#frm_transferencias').submit();
		return true;
	}
}
</script>