	...
	<div class="container">
        <div class="page-title-box">
            <div class="col-md-10" style="text-align: left">
                <p>
                <h4 class="page-title"><?php echo 'Inteligência Pedagógica: Estado' ?></h4>
                </p>
            </div>
        </div>
    </div>    
      		...
      		<div class="col-md-5">
  					...
  					<fieldset>
                          ...
                          <tbody>
                          	...
                          	<?php $primeirom=0; $particapacaom=0; $particapacaomu=0;
                          	    ...
                          	    <td <?=$sintese->estilo?>>
                          	    		NÍVEL:<?=$sintese->ds_descricaofaixa?>
                ...
                <div class="card-box table-responsive" id="listagem_resultado">  					
  						<div class="col-xl-3 col-md-6 mb-4">
  							...
  							<fieldset>
  								<legend>OBJETIVA - Matemática</legend> 					
  							<table class="table table-bordered">
      							<thead>      								
                              		<tr>
                              			<th scope="col"><label>Estado</label></th>                          			
                              			<th scope="col"><label>Avaliação</label></th>
                              			<th scope="col"><label>%Participação</label></th>
                              			<th scope="col"><label>%Acerto</label></th>
                              		</tr>
                              	</thead>
                              	<tbody>
                              	<?php foreach ($registroEscola as $turma){
                              	    if($turma->cd_disciplina==1){?>
                              		<tr>                              	
                              			<td><?=$turma->nm_estado?></br><?=$turma->enturmado?></td>
                              			<td><?=$turma->nm_caderno?></td>
                              			<td><?=round((($turma->fizeram*100)/$turma->enturmado),1)?></td>
                              			<td><?=$turma->pacerto?></td>                              	
                              		</tr>
                              	<?php } }?>	
                              	</tbody>	
  						...
  						<div class="col-xl-3 col-md-6 mb-4">
  							<?php if(isset($registroEscola)){?>
  							<fieldset>
  								<legend>OBJETIVA - Português</legend>  					
  							<table class="table table-bordered">
      							<thead>                              		
                              		<tr><th scope="col"><label>Estado</label></th>                          			
                              			<th scope="col"><label>Avaliação</label></th>
                              			<th scope="col"><label>%Participação</label></th>
                              			<th scope="col"><label>%Acerto</label></th>
                              		</tr>
                	             ...
                	             <table class="table table-bordered">  
                        	       	...
                        	       	<tr><th scope="col" colspan="5"><label>EPV- OBJETIVA - Matemática - POR MUNICÍPIO</label></th></tr>
                        	       		<tr>
                        	       			...
                        	       			<th scope="col"><label>Meta</label></th>
                        	       			</tr>
                        	       	</thead>
                        	       	<tbody>	
                	       	<?php $headimpressom=1;}
                              		...
                              		<tr>
                              			...
                              			<?php }?>	
                              				<td <?=$turma->estilo?>>
                              					...
                              					NOTA:<?=round($turma->vl_proficiencia,1)?>
                              				</td>	
                              			<td> 
...
<div class="card-box table-responsive" id="listagem_resultado">
  		<div class="col-md-6">
                <div class="form-group col-lg-8" hidden>
