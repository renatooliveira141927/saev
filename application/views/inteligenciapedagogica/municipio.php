	...
	<div class="container">
        <div class="page-title-box">
            <div class="col-md-10" style="text-align: left">
                <p>
                <h4 class="page-title"><?php echo 'Inteligência Pedagógica: Município' ?></h4>
                </p>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="container card-box">
        <form action="" method="post" id="acertoerros" name="acertoserros">
    		...
    		<div class="card-box table-responsive" id="listagem_resultado_sintese">
  					...
  					<fieldset>
                          ...
                          <tbody>
                          	...
                          	foreach ($registroPacertoM as $sintese){?>
                          	    ...
                          	    <?php }?>
                          	    <td colspan="2"><label> Proficiência</label></td>
                          	...
                          	<?php $primeirom=0; $particapacaom=0; $particapacaomu=0;
                          	    ...
                          	    <td>Nota:<?=($cont==0)?round(($somapacerto)/1,1):round(($somapacerto)/$cont,1)?></td>
                              	    <!-- QT DE ALUNOS -->
               ...
               <?php if(isset($registroEscola)){?>
                ...
                <div class="card-box table-responsive" id="listagem_resultado_escola">
                	<div class="col-xl-3 col-md-6 mb-4">
                	<fieldset>
                	<legend>DESCRITOR POR ESCOLA</legend>
                	<table class="table table-bordered">
                	       ...
                	       foreach ($registroEscola as $turma){ 
                	           ...
                	           if($turma->cd_disciplina==1 && $headimpressom==0){
                	               $nr_maxcadernos=$turma->nr_cadernos;?>
                        	       	<thead>
                        	       		<tr>
                        	       			<th scope="col"><label>Escola (Matemática)</label></th>
                        	       			<?=$turma->nm_caderno?>
                	       	...
                	       	if($turma->cd_disciplina==2 && $headimpressop==0){
                	       	    $nr_maxcadernos=$turma->nr_cadernos;?>
                        	       	<thead>
                        	       		<tr>
                        	       			<th scope="col"><label>Escola (Português)</label></th>
                        	       			<?=$turma->nm_caderno?>
                        	       			<th scope="col"><label>Proficiência</label></th>
                        	       			<th scope="col"><label>Crescimento</label></th>                        	       			
                        	       		</tr>	
                	       	...
                	       	<?php $headimpressop=1;} ?>
                              	<tbody>
                              		<tr>
                              			<td><?=$turma->nm_escola?></td>
                              			<?=!empty($turma->participacao)?$turma->participacao:'<td><label>0</label></td>'?>
                              			...
                              			<?php }?>
                              				<td <?=$turma->estilo?>>
                              					<?=$turma->ds_descricaofaixa?><br/>
                              					<?=round($turma->proficiencia,1)?>
                              				</td>	
                              			<td> 
            ...
            <div class="card-box table-responsive" id="listagem_resultado_legenda">
				...
				<div class="card-box table-responsive" id="listagem_resultado_mat">                                   
                                    ...
                                    <tr>                                
                                 	  ...
                                 	  <td>                                 	  
                                 	  	 <label data-toggle="tooltip"
                                 	  		   title="<?=$valor->ds_descritor.'-'.$valor->nm_descritor;?>" ><?php echo(trim($valor->ds_descritor));?></label>                                 	  		
                                 	  </td>                                 	                                        
					...
					<div class="card-box table-responsive" id="listagem_resultado_port">                                   
                	       <?php //print_r($registrosDescMat); 
...
<script>
    ...
    function validaForm(){    	
		...
		$('#carregando').show();
		if(etapa==''||disciplina==''||cidade==''||ano==''){
