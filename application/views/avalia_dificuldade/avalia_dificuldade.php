<script src="<?=base_url('assets/listagem_cadastros/js/avalia_dificuldades.js'); ?>"></script>
    <div class="container">
            ...
            <div class="col-md-2" style="text-align: right">
                <p>
                    <a type="button" class="btn btn-custom waves-effect waves-light btn-micro active    "
                       href="<?php echo base_url('avalia_dificuldade/avalia_dificuldades/novo'); ?>">Cadastrar</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card-box">
                <div >
                        ...
                        <div class="col-lg-12">
                            <section class="main row">
                                <div class="form-group">
                                    <label for="nm_avalia_dificuldade">Nome do tipo de dificuldade</label>
                                    <input type="text"
                                           name="nm_avalia_dificuldade"
                                           id="nm_avalia_dificuldade"
                                           tabindex="2"
                                           placeholder="Nome do tipo de dificuldade"
                                           style="text-transform: uppercase;"
                                           class="form-control"
                                           value="<?php echo set_value('nm_avalia_dificuldade');?>">
                    ...
                    <input type="hidden"
                           id="url_base"
                           value="<?php echo base_url('avalia_dificuldade/avalia_dificuldades/')?>">
