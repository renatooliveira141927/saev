                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        if($msg == "success"){
                                            ...
                                            <script type="text/javascript">
                                                mensagem_sucesso("error" , "Não foi possível realizar o cadastro, pois a deficiência já está cadastrado no banco de dados!");
                                            </script>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label id="nm_deficiencia">Nome - Deficiência</label>
