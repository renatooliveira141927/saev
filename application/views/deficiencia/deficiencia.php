<script src="<?=base_url('assets/js/deficiencias.js'); ?>"></script>
            ...
            <div class="col-md-2" style="text-align: right">
                <p>
                    <a type="button" class="btn btn-custom waves-effect waves-light btn-micro active    "
                       href="<?php echo base_url('deficiencia/deficiencia/novo'); ?>">Cadastrar</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card-box">
                <div >
                        ...
                        <div class="col-lg-12">
                            <section class="main row">
                                <div class="form-group">
                                    <label for="nm_deficiencia">Nome da Deficiência</label>
                                    <input type="text"
                                           name="nm_deficiencia"
                                           id="nm_deficiencia"
                                           tabindex="2"
                                           ...
                                           class="form-control"
                                           value="<?php echo set_value('nm_deficiencia');?>">
                    ...
                    <input type="hidden"
                           id="url_base"
                           value="<?php echo base_url('deficiencia/deficiencia')?>">
