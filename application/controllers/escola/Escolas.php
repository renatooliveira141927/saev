...
{
    protected $titulo = 'ADMINISTRAR ESCOLAS';
    ...
    public function listagem_consulta($offset=null){
        ...
        if ($status_sessao!='sessaooff') {
            ...
            $fl_tpunidade       = $this->input->post('fl_tpunidade');           
            $fl_localizacao     = $this->input->post('fl_localizacao');
            $cd_cidade          = !empty($this->input->post('cd_cidade'))?$this->input->post('cd_cidade'):$this->input->post('cd_cidade_sme');
    ...
    public function gerar_excel(){
        ...
        $fl_tpunidade       = $this->input->post('fl_tpunidade');
        $fl_localizacao     = $this->input->post('fl_localizacao');
        $cd_cidade          = $this->input->post('cd_cidade')?$this->input->post('cd_cidade'):$this->input->post('cd_cidade_sme');
        $nr_cep             = $this->input->post('nr_cep');
        $ds_rua             = $this->input->post('ds_rua');
        $nr_residencia      = $this->input->post('nr_residencia');
        $ds_bairro          = $this->input->post('ds_bairro');
    ...
    public function salvar(){
        ...
        $this->form_validation->set_rules('fl_extencao', 'tipo de unidade','required');
        $this->form_validation->set_rules('fl_tpunidade', 'tipo de escola','required');
